    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests( authConfig -> {
                    ...
                    authConfig.requestMatchers(HttpMethod.GET, "/api/v1/weightTracker/listWeightRecordOfGoal/**").hasAuthority("ROLE_" + Role.USER.name());
                    authConfig.requestMatchers(HttpMethod.DELETE, "/api/v1/weightTracker/deleteWeightRecord/**").hasAuthority("ROLE_" + Role.USER.name());
                    // Others
